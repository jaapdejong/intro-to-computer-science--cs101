...
def involved(courses, person):
    ...
    for hexamester in courses:
        ...
        for course in courses[hexamester]:
            if ('teacher' in courses[hexamester][course] and courses[hexamester][course]['teacher'] == person) or ('assistant' in courses[hexamester][course] and courses[hexamester][course]['assistant'] == person):
                result.append(course)
        if len(result) != 0:
            res[hexamester] = result
    return res
